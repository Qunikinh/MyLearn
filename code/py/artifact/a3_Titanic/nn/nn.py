...
datapath = "artifact/a3_Titanic/titanic/Titanic_data.csv"
save_path = os.path.join(os.getcwd(), "artifact/a3_Titanic/nn/epochsaves")
if os.path.exists(save_path) is False: os.makedirs(save_path)

#todo 数据集加载
# 加载数据
custom_dataset = titanic("artifact/a3_Titanic/titanic/Titanic_data.csv")
# 划分训练集、验证集和测试集
